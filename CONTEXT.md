...
reachable two ways: as an in-page overlay launched from the **Badge** (the
...
board; the in-page overlay opens as a large centered modal and the toolbar
surface stays a narrow popup (see ADR-0009). It has two parts: the market-wide trending list
...
**Trending Board** overlay (market-wide). The two and the chart overlay are
mutually exclusive — opening one closes the others. See ADR-0003, ADR-0008, ADR-0009.
